...
namespace Dravencms\Discussion\DI;
...
/**
 * Class DiscussionExtension
 * @package Dravencms\Discussion\DI
 */
class DiscussionExtension extends Nette\DI\CompilerExtension
{
    ...
    public function loadConfiguration()
    {
        ...
        $builder->addDefinition($this->prefix('discussion'))
            ->setClass('Dravencms\Discussion\Discussion', []);
     ...
     */
    public static function register(Configurator $config, $extensionName = 'discussionExtension')
    {
        $config->onCompile[] = function (Configurator $config, Compiler $compiler) use ($extensionName) {
            $compiler->addExtension($extensionName, new DiscussionExtension());
        };
    }
