...
class AclOperationFixtures extends AbstractFixture implements DependentFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        $operations = [
            'discussion' => [
                'edit' => 'Umožnuje editaci Discussion',
                'delete' => 'Umožnuje smazání Discussion'
            ]
        ];
    ...
    {
        return ['Dravencms\Model\Discussion\Fixtures\AclResourceFixtures', 'Dravencms\Model\User\Fixtures\GroupFixtures'];
    }
}